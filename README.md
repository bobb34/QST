...
<H3>When a user takes a QST, you can be certain their mark was not tampered with.</H3>
...
We have just surpassed 26,000 downloads at sourceforge.net .
...
Our latest release is QST version 3.12.11 on June 20, 2026. 
- Released under GPLv2 only (no license required for commercial use). 
- The only assesment software under this license.

We are currently working on our AI templates, which you can use to create questions in qst xml for import in popular AI offerings.

- We are proud of our contribution to open source assessment/examination and our ability to let you "own your questions" without being locked into one vendors format.
